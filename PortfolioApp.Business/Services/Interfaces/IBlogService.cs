...
public interface IBlogService
{
    ...
    Task<IDataResult<BlogPostDto>> GetBySlugAsync(string slug);
    ...
    Task<IDataResult<IList<BlogPostDto>>> GetRecentAsync(int count = 5);
    Task<IDataResult<PaginatedResult<BlogPostDto>>> GetPagedAsync(int page, int pageSize, string? categorySlug = null, string? tagSlug = null, string? search = null);
    ...
    Task<IDataResult<IList<BlogCategoryDto>>> GetCategoriesAsync();
