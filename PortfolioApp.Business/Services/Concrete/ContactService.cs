...
public class ContactService : IContactService
{
    ...
    public ContactService(UnitOfWork uow, IMapper mapper)
    {
        _uow = uow;
        _mapper = mapper;
    }
    ...
    {
        var info = await _uow.GetRepository<ContactInfo>().GetByIdAsync(dto.Id);
    ...
    {
        var msg = await _uow.GetRepository<ContactMessage>().GetByIdAsync(id);
        return msg is null
